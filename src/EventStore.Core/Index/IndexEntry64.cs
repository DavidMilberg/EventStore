...
namespace EventStore.Core.Index
{
    ...
    public unsafe struct IndexEntry64 : IComparable<IIndexEntry>, IEquatable<IIndexEntry>, IIndexEntry
    {
        ...
        public void CopyInto(Stream stream, byte[] buffer)
        {
            ...
            {
                Marshal.Copy((IntPtr)ptr, buffer, 0, PTable.IndexEntry64Size);
                stream.Write(buffer, 0, PTable.IndexEntry64Size);
            }
        }
    }
}